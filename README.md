...
The data is ingested from APIs except for the game_stats, skater_season_stats and goalie_season_stats which are ingested from their corresponding json files which can be found in this repo.
